...
if (data_augmentation):
    ...
    checkpointer = ModelCheckpoint(filepath='model_11.h5', monitor='val_acc', verbose=0, save_best_only=True, mode='auto')
    model.fit_generator(datagen.flow(x_data, y_data, batch_size=batch_size), steps_per_epoch=row/batch_size, verbose=1, callbacks=[checkpointer], validation_data=(v_x_data, v_y_data), epochs=epoch, use_multiprocessing=True)
else :
